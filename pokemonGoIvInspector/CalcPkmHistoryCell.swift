...
class CalcPkmHistoryCell: UITableViewCell {
    ...
    @IBOutlet weak var labelMaxPerf: UILabel!
    @IBOutlet weak var labelAvgPerf: UILabel!
    @IBOutlet weak var labelMinPerf: UILabel!
}
